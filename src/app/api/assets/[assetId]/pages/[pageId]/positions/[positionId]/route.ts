...
export async function GET(
  ...
  try {
    const { pageId, positionId } = await params;
...
export async function PUT(
  ...
  try {
    ...
    await logAudit({
      ...
      entityId: positionId,
      action: "UPDATE",
      details: { updatedFields: Object.keys(parsed.data), pageId, assetId },
    });
...
export async function DELETE(
  ...
  try {
    ...
    await logAudit({
      ...
      entityId: positionId,
      action: "ARCHIVE",
      details: { name: existing.name, pageId, assetId, previousStatus: existing.status },
    });
